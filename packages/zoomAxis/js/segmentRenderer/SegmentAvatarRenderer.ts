...
export class SegmentAvatarRenderer extends SegmentRenderer {
  static SegmentType = 7
  ...
  `;
    ...
    this.wrapper.style.background = '#C66136';
    return this
  }
}
segmentRenderers.add(SegmentAvatarRenderer.SegmentType, SegmentAvatarRenderer);