...
import { Segment, type SegmentClassInfo } from './Segment';
...
export const createSegment = ({type, trackId, segmentInfo}:{ type:SegmentType,  trackId?: string, segmentInfo?: SegmentClassInfo}) => {
...
export const createSegmentToTrack = (segmentName: string, segmentType: SegmentType, segmentInfo: SegmentClassInfo): Segment => {
  const segment = createSegment({type: segmentType, trackId: segmentInfo.trackId, segmentInfo});
  // segment.setName(segmentName)
  // dom.appendChild(createSegmentName());
